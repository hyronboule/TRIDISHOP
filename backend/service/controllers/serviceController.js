...
const paypalPayement = (req, res) => {
    ...
    const paymentData = {
        ...
        redirect_urls: {
            return_url: `http://54.37.50.91:${PORT}/api/service/success?buyerId=${buyerId}&payments=${encodeURIComponent(JSON.stringify(payments))}`,
            cancel_url: `http://54.37.50.91:${PORT}/api/service/cancel`,
        },
        transactions: [{
            amount: {
